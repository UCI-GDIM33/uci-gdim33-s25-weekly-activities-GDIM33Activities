...
3. Why is the shiba from step (3), which is colored with vertex color, less detailed than the shiba we rendered with a texture in last week’s activity? I belive vertex colors, are generated by computer data while the texsture render applies otself to the merticularly planned texsture. 
